...
import com.frothapps.bite.AppDatabase;
                ...
                if (card == null) {
                    ...
                    new AsyncTask<Void, Void, Void>() {
                        ...
                        protected Void doInBackground(Void... voids) {
                            ...
                            Stripe stripe = new Stripe(getApplicationContext(), "pk_test_M2uVFMQ8wi1Yuf1vgDNsb4V7");
                            stripe.createToken(
                                    card,
                                    new TokenCallback() {
    ...
    private void addOrder(final String stripeToken) {
        ...
        StringRequest postRequest = new StringRequest
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("phone_no", "0435787786");
                params.put("extra_notes", "No Requirements");
